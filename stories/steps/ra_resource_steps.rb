...
steps_for(:ra_resource) do
  ...
  #   "Given a account with login: 'mojojojo'" 
  # produces a Account instance stored in @account with 'mojojojo' as its login
  # attribute.
  #
  ...
  #   "And the account has thac0: 3"
  # takes the earlier-defined @account instance and sets its thac0 to '3'.
  #
...
#
# So, for instance,
#   klass, instance = parse_resource_args 'account'
#   instance = klass.new({login => 'me', password => 'monkey', ...})
#   keep_instance! resource, instance
# keeps the just-constructed Account model in the @account instance variable.
#
